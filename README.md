...
🧠🌐 - Je suis en train de développer une application web **No-code IA platform** grâce à Streamlit, qui permet de découvrir les modèles les plus utilisés de Machine Learning, et d'utiliser certains modèles de Deep Learning, pour faire notamment de la détection d'objets sur une image, ou pour faire du transfert learning.
