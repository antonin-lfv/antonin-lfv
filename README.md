...
🪙💰 - J'ai développé une [**sandbox**](https://github.com/antonin-lfv/Parrot_wallet) d'achat de **Cryptomonnaies** avec Flask qui créé un wallet factice avec 10.000$ et qui vous permet de les utiliser comme bon vous semble.
