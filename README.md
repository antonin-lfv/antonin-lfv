...
🩺🫀 – J’ai développé un [**VAE convolutionnel**](https://github.com/antonin-lfv/ECG_Generator) (**auto‑encodeur variationnel convolutionnel**) entraîné sur des électrocardiogrammes pour générer de nouvelles données d’anomalies cardiaques, là où les jeux de données sont rares.
